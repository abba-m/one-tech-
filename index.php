			...
			<div class="row fill_height">
				...
				<div class="col-lg-5 offset-lg-4 fill_height">
					<div class="banner_content">
						...
						<div class="button banner_button"><a href="smartphone.php">Shop Now</a></div>
					</div>
				</div>
			</div>
		</div>
			...
			<div class="row">
				...
				<div class="col-lg-3 col-md-6 char_col">
					...
					<div class="char_item d-flex flex-row align-items-center justify-content-start">
						...
						<div class="char_content">
							...
							<div class="char_subtitle">from NGN500</div>
						</div>
					</div>
				</div>
				...
				<div class="col-lg-3 col-md-6 char_col">
					...
					<div class="char_item d-flex flex-row align-items-center justify-content-start">
						...
						<div class="char_content">
							<div class="char_title">Refreshed Sale</div>
							<div class="char_subtitle">from NGN500</div>
						</div>
					</div>
				</div>
				...
				<div class="col-lg-3 col-md-6 char_col">
					...
					<div class="char_item d-flex flex-row align-items-center justify-content-start">
						...
						<div class="char_content">
							<div class="char_title">10% Discount</div>
							<div class="char_subtitle">from NGN5000</div>
						</div>
					</div>
				</div>
				...
				<div class="col-lg-3 col-md-6 char_col">
					...
					<div class="char_item d-flex flex-row align-items-center justify-content-start">
						...
						<div class="char_content">
							...
							<div class="char_subtitle">from NGN5500</div>
						</div>
					</div>
				</div>
			</div>
								...
								<div class="owl-item deals_item">
									...
									<div class="deals_content">
										<div class="deals_info_line d-flex flex-row justify-content-start">
											...
											<div class="deals_item_price_a ml-auto">NGN300</div>
										</div>
										<div class="deals_info_line d-flex flex-row justify-content-start">
											<div class="deals_item_name">Beoplay H7</div>
											<div class="deals_item_price ml-auto">NGN225</div>
										</div>
										<div class="available">
								...
								<div class="featured_slider slider">
									...
									<div class="featured_slider_item">
										...
										<div class="product_item is_new d-flex flex-column align-items-center justify-content-center text-center">
											<div class="product_image d-flex flex-column align-items-center justify-content-center"><?php echo $product_pic; ?></div>
											<div class="product_content">
												<div class="product_price">NGN<?php echo $p_price; ?></div>
												<div class="product_name"><div><a href="product.php"><?php echo $p_name ?></a></div></div>
												<div class="product_extras">
                                                    ...
                                                    <button name="add" class="product_cart_button">Add to Cart</button>
                                                    </form>
												</div>
                                                <?php 
													if (isset($_POST['add'])){//if isset
														$p_id = $p_id;
														$user_id = $_SESSION['user_id'];
														
														$add_to_cart = mysqli_query ($dbC, "INSERT INTO cart (p_id, user_id)
																			VALUES ('$p_id','$user_id')")or die(mysqli_error());//trader info
						...
						<div class="owl-carousel owl-theme popular_categories_slider">
							...
							<div class="owl-item">
								<div class="popular_category d-flex flex-column align-items-center justify-content-center">
									...
									<div class="popular_category_text">Gadgets & Accessories</div>
								</div>
							</div>
							...
							<div class="owl-item">
								<div class="popular_category d-flex flex-column align-items-center justify-content-center">
									<div class="popular_category_image"><img src="images/popular_2.png" alt=""></div>
									<div class="popular_category_text">Tv</div>
								</div>
							</div>
									...
									<div class="arrivals_slider slider">
										...
										<div class="arrivals_slider_item">
											...
											<div class="product_item is_new d-flex flex-column align-items-center justify-content-center text-center">
												...
												<div class="product_content">
													<div class="product_price">NGN225</div>
									...
									<div class="d-flex flex-column align-items-center justify-content-center">
										...
										<div class="arrivals_single_content">
											...
											<div class="arrivals_single_name_container clearfix">
												...
												<div class="arrivals_single_price text-right">NGN379</div>
											</div>
								...
								<div class="bestsellers_item">
									<div class="bestsellers_item_container d-flex flex-row align-items-center justify-content-start">
										...
										<div class="bestsellers_content">
											...
											<div class="bestsellers_price discount">NGN225<span>NGN300</span></div>
										</div>
									</div>
								...
								<div class="trends_item is_new">
									...
									<div class="trends_content">
										...
										<div class="trends_info clearfix">
											...
											<div class="trends_price">NGN379</div>
										</div>
									</div>
						...
						<div class="owl-carousel owl-theme viewed_slider">
							...
							<div class="owl-item">
								<div class="viewed_item discount d-flex flex-column align-items-center justify-content-center text-center">
									...
									<div class="viewed_content text-center">
										<div class="viewed_price">NGN225<span>NGN300</span></div>
							...
							<div class="owl-item">
								<div class="viewed_item d-flex flex-column align-items-center justify-content-center text-center">
									...
									<div class="viewed_content text-center">
										<div class="viewed_price">NGN379</div>
							...
							<div class="owl-item">
								<div class="viewed_item d-flex flex-column align-items-center justify-content-center text-center">
									...
									<div class="viewed_content text-center">
										<div class="viewed_price">NGN225</div>
							...
							<div class="owl-item">
								<div class="viewed_item d-flex flex-column align-items-center justify-content-center text-center">
									...
									<div class="viewed_content text-center">
										<div class="viewed_price">NGN375</div>
										<div class="viewed_name"><a href="accessories.php">Speedlink...</a></div>
									</div>
									<ul class="item_marks">
										<li class="item_mark item_discount">-25%</li>
										<li class="item_mark item_new">new</li>
